# **n8n Workflow - X, YouTube News Digest**
...
➡️ [Click here to view & download the workflow JSON](https://github.com/varunsharma-co/News-Digest-n8n-Workflow/blob/main/n8n-Workflow-X-YT-News-Digest.json)
